...
var BatchPluginFactory = function() {
  ...
  BatchPluginFactory2.create = function(options) {
    var _a = Object.assign({
      ...
      vertexSize: 6
    }, options), vertex2 = _a.vertex, fragment3 = _a.fragment, vertexSize = _a.vertexSize, geometryClass = _a.geometryClass;
    return function(_super) {
      __extends(BatchPlugin, _super);
      function BatchPlugin(renderer) {
        var _this = _super.call(this, renderer) || this;
        _this.shaderGenerator = new BatchShaderGenerator(vertex2, fragment3);
...
var AlphaFilter = function(_super) {
  __extends2(AlphaFilter2, _super);
  function AlphaFilter2(alpha) {
    if (alpha === void 0) {
      alpha = 1;
    }
    var _this = _super.call(this, defaultVertex$2, fragment2, { uAlpha: 1 }) || this;
    _this.alpha = alpha;
    return _this;
  }
...
var BlurFilterPass = function(_super) {
  __extends3(BlurFilterPass2, _super);
...
//# sourceMappingURL=chunk-MXQZFBXV.js.map
